      ...
      <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
        <div class="max-w-[570px] mb-12 lg:mb-0">
          ...
          <p class="text-base text-body-color dark:text-gray-200 leading-relaxed mb-9">
            Якщо ви вважаєте, що це відповідає вашим потребам, не соромтеся звертатися до нас.
          </p>
          <div class="flex mb-8 max-w-[370px] w-full">
            ...
            <div class="w-full">
              <h4 class="font-bold text-dark dark:text-gray-200 text-lg mb-1">
      ...
      <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
        <div class="bg-white dark:bg-slate-900 relative rounded-lg p-8 sm:p-12 shadow-lg">
              ...
              submitForm(event) {
                ...
                this.errors = {};
                  ...
                  .then(result => {
                    ...
                    this.successMessage = 'Дякуємо за запит на контакт. Ми повернемося до вас найближчим часом.';
                  })
                  .catch(res => {
                    if (res.status === 422) {
          ...
          " x-on:submit.prevent="submitForm">
            ...
            @csrf
            <div class="mb-6">
              <x-forms.input placeholder="Твоє ім'я" name="name" x-model="formData.name" ::class="errors.name ? 'border-red-500 focus:border-red-500' : ''"></x-forms.input>
              <template x-if="errors.name">
                <div x-text="errors.name[0]" class="text-red-500"></div>
              </template>
            </div>
            <div class="mb-6">
              <x-forms.input type="email" placeholder="Твій емейл" name="email" x-model="formData.email" ::class="errors.email ? 'border-red-500 focus:border-red-500' : ''"></x-forms.input>
              <template x-if="errors.email">
                <div x-text="errors.email[0]" class="text-red-500"></div>
              </template>
            </div>
            <div class="mb-6">
              <x-forms.textarea placeholder="Твоє повідомлення" name="message" rows="6" x-model="formData.message" ::class="errors.message ? 'border-red-500 focus:border-red-500' : ''"></x-forms.textarea>
